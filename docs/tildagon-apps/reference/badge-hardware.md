...
The EMF 2026 badge uses a new frontboard with a different physical layout from the 2024 badge. It also adds an alternative groups of types. Both groups of types work for the buttons on the 2024 frontboard and the 2026 frontboard.
